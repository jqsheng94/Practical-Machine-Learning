...
### Cross Validation
After loading the data, it shows that training set has 19622 rows of data and prediction set has 20 rows of data with 160 variables. In order to cross validate data, we split the training data into two seperate sub datasets, one is training set with 60% of data and another one is testing set with 40% of data.
```{r}
